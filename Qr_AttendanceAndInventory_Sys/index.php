                            ...
                            <div class="grid grid-cols-3 w-full gap-9 mb-7">
                                ...
                                <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                                    <div class="flex flex-col justify-between align-center">
                                        <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950 mb-5">68</p>
                                ...
                                <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                                    <div class="flex flex-col justify-between align-center">
                                        <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950 mb-5">30</p>
                                ...
                                <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                                    <div class="flex flex-col justify-between align-center">
                                        <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950 mb-5">145</p>
