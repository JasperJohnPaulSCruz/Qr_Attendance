    ...
    <body>
        ...
        <div class="flex justify-around h-screen w-screen font-poppins pt-[120px] bg-red-50">
            <div class="flex justify-center h-full w-full bg-opacity-75 px-[200px]">
                
                        <!-- scanned student -->
                        <div class=" flex flex-col items-center ">
                            <p class="rounded-lg w-full text-gray-700 py-3 px-4 bg-white shadow-md shadow-red-200 text-nowrap">
                                <span class="font-medium text-green-500">Success!</span>
                                Student QR Code Scan completed!
                            </p>
                            <div class="my-5 p-5 bg-red-900 rounded-lg  flex flex-col justify-between align-center items-center shadow-md shadow-red-200 w-80">
                        ...
                        <!-- line between -->
                        <div class="border-2 border-red-500 border-opacity-50 content-none h-[600px] mx-10"></div>
                        ...
                        <div class="`flex flex-col gap-9 h-full w-full">
                            ...
                            <div class="grid grid-cols-3 w-full gap-9 mb-7">
                                ...
                                <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-red-200">
                                    <div class="flex flex-col justify-between align-center">
                                        <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950 mb-5"><?php echo absent($conn);?></p>
                            ...
                            <div class="relative overflow-x-auto shadow-md shadow-red-200 rounded-lg">
                                <table class="w-full text-sm text-left text-gray-500" id="attendancetoday">
                                    <caption class="relative p-5 text-lg font-semibold text-left text-gray-900 bg-white">
                                        Attendance Today
                                        <a class="absolute right-3 text-[12px] font-medium text-red-800 hover:drop-shadow-md hover:drop-shadow-red-900" href="attendanceoverview">View All  ></a>
                                    </caption>
