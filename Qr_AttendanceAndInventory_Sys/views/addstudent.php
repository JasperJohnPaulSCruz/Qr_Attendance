        ...
        <div class="flex justify-center font-poppins h-full w-full pt-[100px] bg-green-50">
            <div class="bg-opacity-75">
                ...
                <div class="flex justify-end align-center items-center gap-2">
                    ...
                    <button type="button" class="text-teal-700 text-center hover:text-white border border-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                    Add</button>
                </div>
