            ...
            <div class="flex flex-col w-full bg-opacity-75 pl-[200px] pr-[100px] pb-[50px]">
                <div class="flex ">
                    ...
                    <a id="showFacultyInventory" href="#" class=" font-medium ">
                        <div id="invbutton" class="w-full bg-white shadow-md shadow-green-200 px-5 py-5 cursor-pointer flex mb-5 hover:bg-gray-200">
                        <div class="flex flex-col">
                            <span class="text-[30px]">0</span>
                            Faculty Inventory
                        </div>
                        <svg class="text-green-700 ml-5" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="currentColor" d="M5 5h2v3h10V5h2v5h2V5c0-1.1-.9-2-2-2h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h6v-2H5zm7-2c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1"/><path fill="currentColor" d="M21 11.5L15.51 17l-3.01-3l-1.5 1.5l4.51 4.5l6.99-7z"/></svg>
                        </div>
                    </a>
                </div>
