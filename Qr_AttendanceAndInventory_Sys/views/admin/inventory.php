<?php
    ...
    <body>
        ...
        <script>
            document.getElementById("showListOfItems").addEventListener('click', function(){
            ...
            document.getElementById("showFacultyInventory").addEventListener('click', function(){
            if(document.getElementById("facultyInventory").classList.contains('hidden') ){
                console.log('show faculty inventory');
