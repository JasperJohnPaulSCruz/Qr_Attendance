    ...
    <body>
        ...
        <div class="flex justify-around font-poppins pt-[100px] bg-green-50 h-screen">
                    ...
                    <div class="grid grid-cols-4  gap-9 mb-7">
                        <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                            <div class="flex flex-col justify-between align-center">
                                <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950"><?php echo $total_student;?></p>
                        ...
                        <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                            <div class="flex flex-col justify-between align-center">
                                <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950"><?php echo $present;?></p>
                        ...
                        <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                            <div class="flex flex-col justify-between align-center">
                                <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950"><?php echo $late;?></p>
                        ...
                        <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                            <div class="flex flex-col justify-between align-center">
                                <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950"><?php echo $absent;?></p>
