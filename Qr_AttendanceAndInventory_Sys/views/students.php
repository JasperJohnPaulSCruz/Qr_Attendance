    ...
    <body>
        ...
        <div class="flex justify-around font-poppins pt-[100px] bg-green-50">
            <div class="flex justify-center h-full w-full bg-opacity-75">
                ...
                <div class="mr-[30px]">
                    <div class=" w-full mb-5 flex gap-5">
                        <div class="relative w-full h-full">
                            ...
                            <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-teal-700 rounded-e-lg border border-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                ...
                <div class="flex flex-col gap-9 mb-7">
                    ...
                    <div class="p-6  bg-white rounded-lg flex justify-between shadow-md shadow-green-200">
                        <div class="flex flex-col justify-between align-center">
                            <p class="font-bold text-[35px] tracking-wide font-outfit text-gray-950">456</p>
